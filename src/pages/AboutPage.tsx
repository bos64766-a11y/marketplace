...
export const AboutPage: React.FC = () => {
  const { navigate, partners, t, language } = useApp();
    ...
    <div className="max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="p-6 rounded-2xl bg-white border border-[#E5EAF2] shadow-xs space-y-3">
          ...
          <h3 className="font-bold text-base text-[#0B2E73]">{t.aboutPage.pillar1Title}</h3>
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#E5EAF2] shadow-xs space-y-3">
          ...
          <h3 className="font-bold text-base text-[#0B2E73]">{t.aboutPage.pillar2Title}</h3>
          <p className="text-xs text-[#667085] leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#E5EAF2] shadow-xs space-y-3">
          ...
          <h3 className="font-bold text-base text-[#0B2E73]">{t.aboutPage.pillar3Title}</h3>
          <p className="text-xs text-[#667085] leading-relaxed">
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#E5EAF2] shadow-xs space-y-3">
          ...
          <h3 className="font-bold text-base text-[#0B2E73]">{t.aboutPage.pillar4Title}</h3>
          <p className="text-xs text-[#667085] leading-relaxed">
            {t.aboutPage.pillar4Desc}
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#F7F9FC] rounded-3xl border border-[#E5EAF2] p-8 sm:p-10 space-y-6">
        <div className="text-center max-w-xl mx-auto space-y-2">
          <h2 className="text-2xl font-bold text-[#0B2E73]">{t.aboutPage.partnersTitle}</h2>
      ...
      <div className="text-center p-8 bg-white rounded-3xl border border-[#E5EAF2] shadow-xs space-y-4">
        <h3 className="text-xl font-bold text-[#0B2E73]">{t.aboutPage.ctaTitle}</h3>
